...
bool EffectDummyCreature_npc_door_seal(Unit* pCaster, uint32 uiSpellId, uint32 /*SpellEffectIndex */ uiEffIndex, Creature* pCreatureTarget)
{
...
bool EffectDummyCreature_npc_teleportation_portal(Unit* pCaster, uint32 uiSpellId, uint32/* SpellEffectIndex*/ uiEffIndex, Creature* pCreatureTarget)
{
    //always check spellid and effectindex
